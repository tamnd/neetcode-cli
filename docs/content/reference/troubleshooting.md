...
Most of these come down to network reality or how neetcode serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

neetcode rate-limits like any public site. nc already paces
...
Where a surface is gated, nc reads a cookie or token you supply
...
`nc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nc actually did
